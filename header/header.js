const baseURL = (document.currentScript && document.currentScript.src.split("header/")[0]) || "";
...
function initHeader() {
  ...
  function aplicarTemaSalvo() {
    ...
    if (temaSalvo === "escuro") {
      ...
      logo.src = baseURL + "assets/images/logo-black.png";
    } else {
      body.classList.remove("dark-theme");
      icone.classList.replace("bx-sun", "bx-moon");
      logo.src = baseURL + "assets/images/logo-white.png";
    }
  }
